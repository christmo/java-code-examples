...
public class DbUnitRule implements MethodRule {
                ...
                try {
                    ...
                    if (ddl != null) {
                        ...
                        for (String value : values) {
                            ...
                            executeUpdate(Resources.toString(Thread.currentThread().getContextClassLoader().getResource(value), Charset.defaultCharset()));
                        }
                    }
                    ...
                    if (data != null) {
                        ...
                        IDataSet ds = new JSONDataSet(Thread.currentThread().getContextClassLoader().getResourceAsStream(data.value()));
    ...
    public IDataSet jsonDataSet(String datasetResource) {
        return new JSONDataSet(Thread.currentThread().getContextClassLoader().getResourceAsStream(datasetResource));
    }
